...
const ResProperty = () =>{
    let[resproperty, updateResProperty] = useState( [] );
    let getResProperty = () =>{
        let url= "https://realestateapi.onrender.com/property?ptype=residential";
        fetch(url)
        .then(response => response.json())
        .then(propertyArray=>{
            updateResProperty(propertyArray.reverse());    ////.reverse() Newly added property will come on the top
        })
    }
    ...
    const pageCount = Math.ceil(resproperty.length / PER_PAGE);
    // pagination end 
                ...
                <div className="contaimer mt-5">
                    ...
                    <div className="row mt-4 mb-3">
                        <div className="col-lg-6">
                            <h3 className="text-success text-center"> Real Estate Residential Properties </h3>
                        </div>
